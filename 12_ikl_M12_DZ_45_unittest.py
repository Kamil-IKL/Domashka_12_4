...
class RunnerTest(unittest.TestCase):
    def test_walk(self):
        try:
            ...
            logging.warning(f'"test_walk", неверная скорость для Runner(бегуна): {name_r1}')
    ...
    def test_run(self):
        try:
            ...
            logging.warning(f'"test_run", неверный тип данных для объекта Runner(бегуна): {name_r2}')
    ...
    def test_challenge(self):
        try:
            ...
            logging.warning(f'"test_challenge", неверно указан аргумент для Runner(бегуна)')


"""
ОБРАТИ ВНИМАНИЕ !
Если будет запустишь после теста логирование, то работать не будет !!!! 
